      ...
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        {!hasStarted && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/90 p-4">
            ...
            <button
              onClick={handleStart}
              className="bg-primary hover:opacity-90 text-privacy-black font-bold py-4 px-10 rounded-xl transition-opacity shadow-lg shadow-primary/30 flex items-center gap-2"
            >
